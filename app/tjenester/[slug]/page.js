...
export default function ServicePage(){
 ...
 const [service,setService]=useState(null),[loading,setLoading]=useState(true),[menuOpen,setMenuOpen]=useState(false);
 ...
 return <main className="serviceDetail">
  <header className="serviceDetailHeader"><div className="serviceDetailNav"><a href="/"><img src="/aadland-service-logo.webp" alt="Aadland Service"/></a><nav className={"serviceDetailLinks "+(menuOpen?"menuOpen":"")} onClick={()=>setMenuOpen(false)}><a href="/">Hjem</a><a href="/#tjenester">Tjenester</a><a href="/produkter">Produkter</a><a href="/utleie">Utleie</a><a href="/#kontakt">Kontakt</a></nav><button className="mobileMenuBtn serviceDetailMenu" type="button" aria-label={menuOpen?"Lukk meny":"Åpne meny"} aria-expanded={menuOpen} onClick={()=>setMenuOpen(!menuOpen)}><span></span><span></span><span></span></button><a className="goldBtn serviceDetailSurvey" href="/#befaring" onClick={survey}>Gratis befaring →</a></div></header>
