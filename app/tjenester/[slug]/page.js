...
export default function ServicePage(){
 ...
 return <main className="serviceDetail">
  <header className="serviceDetailHeader"><div className="serviceDetailNav"><a href="/"><img src="/aadland-service-logo.webp" alt="Aadland Service"/></a><a className="goldBtn" href="/#befaring" onClick={survey}>Gratis befaring →</a></div></header>
