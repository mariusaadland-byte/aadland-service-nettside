...
export async function POST(req){
 ...
 try{
  ...
  const {error:updateError}=await s.auth.admin.updateUserById(user.id,{password:nextPassword,user_metadata:{...(user.user_metadata||{}),[SESSION_VERSION_FIELD]:nextSessionVersion}});
  if(updateError){
