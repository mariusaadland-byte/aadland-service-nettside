...
export async function GET(){
 ...
 const [ordersResult,rentalsResult,quotesResult]=await Promise.all([
  s.from("orders")
   .select("id,order_number,order_type,status,total_ore,shipping_ore,payment_status,fulfillment_type,items,custom_request,survey_date,survey_confirmation_sent_at,survey_reminder_sent_at,created_at,job_start_at,job_customer_agreement,job_planning_updated_at,job_confirmation_sent_at")
