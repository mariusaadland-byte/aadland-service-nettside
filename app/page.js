...
export default function Home(){
 ...
 </div></div><div><b>Firma</b><div className="footerServices"><a href="#om">Om oss</a><a href="#prosjekter">Tidligere oppdrag</a><a href="#befaring">Gratis befaring</a><a href="/vilkar/utleie">Utleiebetingelser</a><a href="/vilkar/salg">Salgsbetingelser</a></div><p>Org.nr. {siteSettings.orgNumber}<br/>{siteSettings.location}</p></div></div><div className="homeWrap footerBottom"><span>© Aadland Service</span><div><a href="/min-side">Min side</a><a href="/produkter">Produkter</a><a href="#tjenester">Tjenester</a><a href="#kontakt">Kontakt</a></div></div></footer>
 </main>;
}
